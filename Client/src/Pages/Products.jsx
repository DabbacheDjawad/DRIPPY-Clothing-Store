            ...
            <div className="flex flex-col md:flex-row justify-between gap-4 items-center">
              <div className="flex flex-col sm:flex-row gap-4 w-full">
                ...
                <div className="w-full sm:w-48">
                  ...
                  <select
                    className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#ff6c00] focus:border-transparent transition-all"
              ...
              <div className="relative w-full md:w-64">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff6c00] focus:border-transparent transition-all"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredProducts.map((product) => (
              <Link to={`/admin/products/${product._id}`} key={product._id}>
                <div className="bg-white rounded-lg shadow-[0_15px_30px_-5px_rgba(151,65,252,0.1)] overflow-hidden hover:shadow-[0_15px_30px_-5px_rgba(151,65,252,0.2)] transition-all duration-300 hover:-translate-y-1">
                  {/* Product Image */}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-[#ff6c00] font-bold">
                        {product.price} DZD
                      </span>
                      <span
            ...
            {error && (
              <p className="text-red-600 text-xl text-center font-bold w-full">
                {error}
              </p>
            )}
          </div>
